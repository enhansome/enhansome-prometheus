...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,900 | 🐛 884 | 🌐 Go | 📅 2026-08-29 - Prometheus' source code, issues discussion and collaboration.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,462 | 🐛 181 | 🌐 Go | 📅 2026-08-18 - The MySQL server exporter periodically scrapes MySQL stats.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,740 | 🐛 303 | 🌐 Go | 📅 2026-08-29 - The Node exporter periodically scrapes system stats.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,850 | 🐛 168 | 🌐 Go | 📅 2026-08-27 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,170 | 🐛 47 | 🌐 Astro | 📅 2026-08-23 - Awesome List of Prometheus alerting rules.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,088 | 🐛 9 | 🌐 Go | 📅 2026-08-29 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,616 | 🐛 782 | 🌐 Go | 📅 2026-08-29 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,190 | 🐛 886 | 🌐 Go | 📅 2026-08-26 - Highly available Prometheus setup with long term storage capabilities.
