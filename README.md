...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,187 | 🐛 912 | 🌐 Go | 📅 2026-09-23 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,978 | 🐛 300 | 🌐 Go | 📅 2026-09-22 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,800 | 🐛 319 | 🌐 Go | 📅 2026-09-21 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,330 | 🐛 13 | 🌐 Java | 📅 2026-09-18 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,176 | 🐛 103 | 🌐 Go | 📅 2026-09-18 - The exporter for SNMP metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,880 | 🐛 163 | 🌐 Go | 📅 2026-09-17 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,200 | 🐛 36 | 🌐 Astro | 📅 2026-09-18 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,680 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-22 - Alert dashboard for Prometheus Alertmanager.
...
* [Promxy](https://github.com/jacksontj/promxy) ⭐ 1,322 | 🐛 18 | 🌐 Go | 📅 2026-09-18 - Deduplicates data from Prometheus HA pairs.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,756 | 🐛 829 | 🌐 Go | 📅 2026-09-23 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,212 | 🐛 900 | 🌐 Go | 📅 2026-09-23 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,865 | 🐛 341 | 🌐 Go | 📅 2026-09-22 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,902 | 🐛 172 | 🌐 Go | 📅 2026-09-23 - Scalable long-term remote storage for Prometheus.
