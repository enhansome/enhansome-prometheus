...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,111 | 🐛 898 | 🌐 Go | 📅 2026-09-17 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 297 | 🌐 Go | 📅 2026-09-17 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
* [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) ⭐ 773 | 🐛 207 | 🌐 Python | 📅 2026-09-17 - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace *by GoogleCloudPlatform*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,462 | 🐛 162 | 🌐 Go | 📅 2026-09-15 - The MySQL server exporter periodically scrapes MySQL stats.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,786 | 🐛 315 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,329 | 🐛 12 | 🌐 Java | 📅 2026-09-18 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,171 | 🐛 103 | 🌐 Go | 📅 2026-09-17 - The exporter for SNMP metrics.
* [StatsD exporter](https://github.com/prometheus/statsd_exporter) ⭐ 987 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - The exporter for StatsD metrics.
* [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) ⭐ 977 | 🐛 54 | 🌐 Java | 📅 2026-09-18 - The exporter for Amazon AWS CloudWatch metrics.
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 405 | 🐛 16 | 🌐 Go | 📅 2026-09-17 - The exporter for Graphite metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,876 | 🐛 167 | 🌐 Go | 📅 2026-09-17 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,197 | 🐛 37 | 🌐 Astro | 📅 2026-09-18 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,682 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-17 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,091 | 🐛 7 | 🌐 Go | 📅 2026-09-18 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
* [Promxy](https://github.com/jacksontj/promxy) ⭐ 1,321 | 🐛 18 | 🌐 Go | 📅 2026-09-18 - Deduplicates data from Prometheus HA pairs.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,734 | 🐛 817 | 🌐 Go | 📅 2026-09-18 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,207 | 🐛 910 | 🌐 Go | 📅 2026-09-17 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,863 | 🐛 343 | 🌐 Go | 📅 2026-09-18 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,896 | 🐛 222 | 🌐 Go | 📅 2026-09-18 - Scalable long-term remote storage for Prometheus.
