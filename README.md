...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,827 | 🐛 906 | 🌐 Go | 📅 2026-08-25 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,974 | 🐛 309 | 🌐 Go | 📅 2026-08-25 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,460 | 🐛 181 | 🌐 Go | 📅 2026-08-18 - The MySQL server exporter periodically scrapes MySQL stats.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,720 | 🐛 310 | 🌐 Go | 📅 2026-08-21 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,320 | 🐛 12 | 🌐 Java | 📅 2026-08-25 - The exporter for JMX metrics.
...
* [InfluxDB](https://github.com/prometheus/influxdb_exporter) ⭐ 289 | 🐛 9 | 🌐 Go | 📅 2026-08-25 - The exporter for InfluxDB metrics.
* [Collectd exporter](https://github.com/prometheus/collectd_exporter) ⭐ 267 | 🐛 26 | 🌐 Go | 📅 2026-08-06 - The exporter for Collectd metrics.

### Miscellaneous

* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,841 | 🐛 166 | 🌐 Go | 📅 2026-08-25 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.
...
* [Karma](https://github.com/prymitive/karma) ⭐ 2,679 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-25 - Alert dashboard for Prometheus Alertmanager.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,594 | 🐛 782 | 🌐 Go | 📅 2026-08-25 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,186 | 🐛 880 | 🌐 Go | 📅 2026-08-24 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,856 | 🐛 353 | 🌐 Go | 📅 2026-08-26 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,894 | 🐛 225 | 🌐 Go | 📅 2026-08-17 - Scalable long-term remote storage for Prometheus.
