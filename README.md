...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,047 | 🐛 888 | 🌐 Go | 📅 2026-09-11 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 298 | 🌐 Go | 📅 2026-09-11 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,779 | 🐛 312 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,328 | 🐛 12 | 🌐 Java | 📅 2026-09-09 - The exporter for JMX metrics.
...
* [Karma](https://github.com/prymitive/karma) ⭐ 2,684 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-11 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,090 | 🐛 10 | 🌐 Go | 📅 2026-09-12 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,701 | 🐛 798 | 🌐 Go | 📅 2026-09-11 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,204 | 🐛 902 | 🌐 Go | 📅 2026-09-11 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,862 | 🐛 348 | 🌐 Go | 📅 2026-09-11 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
