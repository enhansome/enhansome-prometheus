...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,170 | 🐛 909 | 🌐 Go | 📅 2026-09-22 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,978 | 🐛 298 | 🌐 Go | 📅 2026-09-21 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,797 | 🐛 318 | 🌐 Go | 📅 2026-09-21 - The Node exporter periodically scrapes system stats.
...
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,175 | 🐛 103 | 🌐 Go | 📅 2026-09-18 - The exporter for SNMP metrics.
...
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 405 | 🐛 17 | 🌐 Go | 📅 2026-09-18 - The exporter for Graphite metrics.
...
* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,198 | 🐛 36 | 🌐 Astro | 📅 2026-09-18 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,681 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-21 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,091 | 🐛 10 | 🌐 Go | 📅 2026-09-22 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,753 | 🐛 818 | 🌐 Go | 📅 2026-09-22 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,210 | 🐛 909 | 🌐 Go | 📅 2026-09-21 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,865 | 🐛 345 | 🌐 Go | 📅 2026-09-22 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,901 | 🐛 174 | 🌐 Go | 📅 2026-09-22 - Scalable long-term remote storage for Prometheus.
