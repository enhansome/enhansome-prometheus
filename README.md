...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,916 | 🐛 883 | 🌐 Go | 📅 2026-08-31 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 314 | 🌐 Go | 📅 2026-08-28 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,462 | 🐛 179 | 🌐 Go | 📅 2026-08-18 - The MySQL server exporter periodically scrapes MySQL stats.
* [Consul exporter](https://github.com/prometheus/consul_exporter) ⭐ 470 | 🐛 35 | 🌐 Go | 📅 2026-08-06 - The exporter for Consul metrics.
* [Memcached exporter](https://github.com/prometheus/memcached_exporter) ⭐ 205 | 🐛 5 | 🌐 Go | 📅 2026-08-24 - The Memcached exporter periodically scrapes Memcached stats.

### Hardware related

* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,745 | 🐛 303 | 🌐 Go | 📅 2026-08-29 - The Node exporter periodically scrapes system stats.
...
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,165 | 🐛 105 | 🌐 Go | 📅 2026-08-29 - The exporter for SNMP metrics.
...
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 404 | 🐛 15 | 🌐 Go | 📅 2026-08-05 - The exporter for Graphite metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,851 | 🐛 168 | 🌐 Go | 📅 2026-08-27 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,088 | 🐛 11 | 🌐 Go | 📅 2026-08-30 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,618 | 🐛 785 | 🌐 Go | 📅 2026-08-31 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,191 | 🐛 887 | 🌐 Go | 📅 2026-08-26 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,857 | 🐛 352 | 🌐 Go | 📅 2026-08-31 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
