...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,123 | 🐛 905 | 🌐 Go | 📅 2026-09-19 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 297 | 🌐 Go | 📅 2026-09-18 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,789 | 🐛 315 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,330 | 🐛 12 | 🌐 Java | 📅 2026-09-18 - The exporter for JMX metrics.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,091 | 🐛 11 | 🌐 Go | 📅 2026-09-18 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,742 | 🐛 819 | 🌐 Go | 📅 2026-09-19 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,208 | 🐛 908 | 🌐 Go | 📅 2026-09-18 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,863 | 🐛 342 | 🌐 Go | 📅 2026-09-18 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,897 | 🐛 221 | 🌐 Go | 📅 2026-09-19 - Scalable long-term remote storage for Prometheus.
