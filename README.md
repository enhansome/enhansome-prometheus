...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,940 | 🐛 889 | 🌐 Go | 📅 2026-09-04 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 297 | 🌐 Go | 📅 2026-09-04 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 171 | 🌐 Go | 📅 2026-09-04 - The MySQL server exporter periodically scrapes MySQL stats.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,757 | 🐛 304 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,323 | 🐛 14 | 🌐 Java | 📅 2026-09-04 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,167 | 🐛 102 | 🌐 Go | 📅 2026-09-03 - The exporter for SNMP metrics.
...
* [Collectd exporter](https://github.com/prometheus/collectd_exporter) ⭐ 268 | 🐛 26 | 🌐 Go | 📅 2026-09-01 - The exporter for Collectd metrics.

### Miscellaneous

* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,862 | 🐛 170 | 🌐 Go | 📅 2026-09-01 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,178 | 🐛 49 | 🌐 Astro | 📅 2026-09-03 - Awesome List of Prometheus alerting rules.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,088 | 🐛 11 | 🌐 Go | 📅 2026-09-03 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,648 | 🐛 786 | 🌐 Go | 📅 2026-09-03 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,195 | 🐛 892 | 🌐 Go | 📅 2026-09-03 - Highly available Prometheus setup with long term storage capabilities.
