...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,102 | 🐛 889 | 🌐 Go | 📅 2026-09-17 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 296 | 🌐 Go | 📅 2026-09-15 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
* [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) ⭐ 773 | 🐛 206 | 🌐 Python | 📅 2026-09-16 - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace *by GoogleCloudPlatform*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,784 | 🐛 314 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,328 | 🐛 12 | 🌐 Java | 📅 2026-09-16 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,171 | 🐛 104 | 🌐 Go | 📅 2026-09-16 - The exporter for SNMP metrics.
...
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 405 | 🐛 15 | 🌐 Go | 📅 2026-09-17 - The exporter for Graphite metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,875 | 🐛 174 | 🌐 Go | 📅 2026-09-16 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.
...
* [Karma](https://github.com/prymitive/karma) ⭐ 2,682 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-16 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,090 | 🐛 3 | 🌐 Go | 📅 2026-09-16 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,728 | 🐛 811 | 🌐 Go | 📅 2026-09-17 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,205 | 🐛 908 | 🌐 Go | 📅 2026-09-16 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,862 | 🐛 342 | 🌐 Go | 📅 2026-09-17 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,896 | 🐛 223 | 🌐 Go | 📅 2026-09-17 - Scalable long-term remote storage for Prometheus.
