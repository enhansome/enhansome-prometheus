...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,719 | 🐛 896 | 🌐 Go | 📅 2026-08-15 - Prometheus' source code, issues discussion and collaboration.
* [Official Prometheus demo](https://demo.do.prometheus.io) - Official Prometheus demo site managed by Cloud Alchemy Ansible roles updating daily using configuration from [Prometheus repository](https://github.com/prometheus/demo-site) ⭐ 128 | 🐛 13 | 🌐 HTML | 📅 2026-08-10.
...
* [Prometheus-Basics](https://github.com/yolossn/Prometheus-Basics) ⚠️ Archived - Beginner friendly introduction to Prometheus by [yolossn](https://github.com/yolossn).
* [Instructions and example code for a Prometheus workshop](https://github.com/juliusv/prometheus_workshop) ⚠️ Archived - Instructions and example code for a Prometheus workshop by Julius Volz.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 297 | 🌐 Go | 📅 2026-08-14 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
* [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) ⭐ 774 | 🐛 206 | 🌐 Python | 📅 2026-08-13 - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace *by GoogleCloudPlatform*.
...
* [Ansitheus](https://github.com/ntk148v/ansitheus) ⭐ 30 | 🐛 4 | 🌐 Jinja | 📅 2026-08-10 - Ansible playbook to containerize, configure and deploy Prometheus ecosystem *by ntk148v*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 185 | 🌐 Go | 📅 2026-08-13 - The MySQL server exporter periodically scrapes MySQL stats.
* [Consul exporter](https://github.com/prometheus/consul_exporter) ⭐ 469 | 🐛 35 | 🌐 Go | 📅 2026-08-06 - The exporter for Consul metrics.
* [Memcached exporter](https://github.com/prometheus/memcached_exporter) ⭐ 203 | 🐛 5 | 🌐 Go | 📅 2026-08-14 - The Memcached exporter periodically scrapes Memcached stats.

### Hardware related

* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,700 | 🐛 322 | 🌐 Go | 📅 2026-08-08 - The Node exporter periodically scrapes system stats.

### HTTP

* [HAProxy exporter](https://github.com/prometheus/haproxy_exporter) ⚠️ Archived - The HAProxy exporter periodically scrapes HAProxy stats.

### Other monitoring systems

* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,320 | 🐛 15 | 🌐 Java | 📅 2026-08-17 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,160 | 🐛 101 | 🌐 Go | 📅 2026-08-10 - The exporter for SNMP metrics.
* [StatsD exporter](https://github.com/prometheus/statsd_exporter) ⭐ 983 | 🐛 25 | 🌐 Go | 📅 2026-08-11 - The exporter for StatsD metrics.
* [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) ⭐ 975 | 🐛 66 | 🌐 Java | 📅 2026-08-13 - The exporter for Amazon AWS CloudWatch metrics.
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 400 | 🐛 14 | 🌐 Go | 📅 2026-08-05 - The exporter for Graphite metrics.
* [InfluxDB](https://github.com/prometheus/influxdb_exporter) ⭐ 289 | 🐛 10 | 🌐 Go | 📅 2026-08-06 - The exporter for InfluxDB metrics.
* [Collectd exporter](https://github.com/prometheus/collectd_exporter) ⭐ 267 | 🐛 26 | 🌐 Go | 📅 2026-08-06 - The exporter for Collectd metrics.

### Miscellaneous

* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,823 | 🐛 169 | 🌐 Go | 📅 2026-08-12 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,153 | 🐛 45 | 🌐 Astro | 📅 2026-08-12 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,676 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-15 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,087 | 🐛 33 | 🌐 Go | 📅 2026-08-14 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,546 | 🐛 775 | 🌐 Go | 📅 2026-08-17 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,179 | 🐛 876 | 🌐 Go | 📅 2026-08-15 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,850 | 🐛 343 | 🌐 Go | 📅 2026-08-16 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,892 | 🐛 219 | 🌐 Go | 📅 2026-06-17 - Scalable long-term remote storage for Prometheus.
