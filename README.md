...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,929 | 🐛 882 | 🌐 Go | 📅 2026-08-31 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 314 | 🌐 Go | 📅 2026-08-31 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,462 | 🐛 175 | 🌐 Go | 📅 2026-08-18 - The MySQL server exporter periodically scrapes MySQL stats.
* [Consul exporter](https://github.com/prometheus/consul_exporter) ⭐ 470 | 🐛 34 | 🌐 Go | 📅 2026-09-01 - The exporter for Consul metrics.
* [Memcached exporter](https://github.com/prometheus/memcached_exporter) ⭐ 206 | 🐛 5 | 🌐 Go | 📅 2026-08-24 - The Memcached exporter periodically scrapes Memcached stats.

### Hardware related

* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,748 | 🐛 300 | 🌐 Go | 📅 2026-08-31 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,322 | 🐛 12 | 🌐 Java | 📅 2026-08-31 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,166 | 🐛 103 | 🌐 Go | 📅 2026-09-01 - The exporter for SNMP metrics.
...
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 404 | 🐛 14 | 🌐 Go | 📅 2026-09-01 - The exporter for Graphite metrics.
* [InfluxDB](https://github.com/prometheus/influxdb_exporter) ⭐ 290 | 🐛 9 | 🌐 Go | 📅 2026-08-25 - The exporter for InfluxDB metrics.
* [Collectd exporter](https://github.com/prometheus/collectd_exporter) ⭐ 268 | 🐛 25 | 🌐 Go | 📅 2026-09-01 - The exporter for Collectd metrics.

### Miscellaneous

* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,853 | 🐛 168 | 🌐 Go | 📅 2026-09-01 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,172 | 🐛 47 | 🌐 Astro | 📅 2026-08-23 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,681 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-31 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,088 | 🐛 12 | 🌐 Go | 📅 2026-08-30 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,626 | 🐛 775 | 🌐 Go | 📅 2026-09-01 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,195 | 🐛 889 | 🌐 Go | 📅 2026-08-26 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,858 | 🐛 352 | 🌐 Go | 📅 2026-09-01 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,895 | 🐛 227 | 🌐 Go | 📅 2026-08-17 - Scalable long-term remote storage for Prometheus.
