...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,765 | 🐛 891 | 🌐 Go | 📅 2026-08-20 - Prometheus' source code, issues discussion and collaboration.
* [Official Prometheus demo](https://demo.do.prometheus.io) - Official Prometheus demo site managed by Cloud Alchemy Ansible roles updating daily using configuration from [Prometheus repository](https://github.com/prometheus/demo-site) ⭐ 128 | 🐛 14 | 🌐 HTML | 📅 2026-08-20.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,973 | 🐛 304 | 🌐 Go | 📅 2026-08-20 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,708 | 🐛 324 | 🌐 Go | 📅 2026-08-19 - The Node exporter periodically scrapes system stats.
...
* [StatsD exporter](https://github.com/prometheus/statsd_exporter) ⭐ 983 | 🐛 26 | 🌐 Go | 📅 2026-08-19 - The exporter for StatsD metrics.
* [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) ⭐ 975 | 🐛 66 | 🌐 Java | 📅 2026-08-20 - The exporter for Amazon AWS CloudWatch metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,832 | 🐛 169 | 🌐 Go | 📅 2026-08-20 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,162 | 🐛 46 | 🌐 Astro | 📅 2026-08-21 - Awesome List of Prometheus alerting rules.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,088 | 🐛 28 | 🌐 Go | 📅 2026-08-20 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,571 | 🐛 771 | 🌐 Go | 📅 2026-08-21 - Cost-effective easy to operate remote storage for Prometheus.
...
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,851 | 🐛 363 | 🌐 Go | 📅 2026-08-20 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
