...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,017 | 🐛 888 | 🌐 Go | 📅 2026-09-10 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 298 | 🌐 Go | 📅 2026-09-09 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
* [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) ⭐ 773 | 🐛 205 | 🌐 Python | 📅 2026-09-09 - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace *by GoogleCloudPlatform*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,773 | 🐛 310 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,327 | 🐛 13 | 🌐 Java | 📅 2026-09-09 - The exporter for JMX metrics.
...
* [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) ⭐ 977 | 🐛 68 | 🌐 Java | 📅 2026-09-03 - The exporter for Amazon AWS CloudWatch metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,867 | 🐛 174 | 🌐 Go | 📅 2026-09-09 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,184 | 🐛 37 | 🌐 Astro | 📅 2026-09-10 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,683 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-09 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,089 | 🐛 11 | 🌐 Go | 📅 2026-09-07 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
* [Promxy](https://github.com/jacksontj/promxy) ⭐ 1,321 | 🐛 18 | 🌐 Go | 📅 2026-09-09 - Deduplicates data from Prometheus HA pairs.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,690 | 🐛 796 | 🌐 Go | 📅 2026-09-10 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,203 | 🐛 901 | 🌐 Go | 📅 2026-09-09 - Highly available Prometheus setup with long term storage capabilities.
