...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,198 | 🐛 905 | 🌐 Go | 📅 2026-09-23 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,979 | 🐛 299 | 🌐 Go | 📅 2026-09-23 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
* [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) ⭐ 773 | 🐛 206 | 🌐 Python | 📅 2026-09-23 - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace *by GoogleCloudPlatform*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,804 | 🐛 321 | 🌐 Go | 📅 2026-09-21 - The Node exporter periodically scrapes system stats.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,882 | 🐛 159 | 🌐 Go | 📅 2026-09-17 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,199 | 🐛 36 | 🌐 Astro | 📅 2026-09-18 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,679 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-22 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,091 | 🐛 11 | 🌐 Go | 📅 2026-09-22 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,761 | 🐛 815 | 🌐 Go | 📅 2026-09-24 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,215 | 🐛 900 | 🌐 Go | 📅 2026-09-23 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,866 | 🐛 342 | 🌐 Go | 📅 2026-09-23 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,902 | 🐛 173 | 🌐 Go | 📅 2026-09-23 - Scalable long-term remote storage for Prometheus.
