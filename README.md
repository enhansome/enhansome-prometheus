...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,148 | 🐛 902 | 🌐 Go | 📅 2026-09-21 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,979 | 🐛 299 | 🌐 Go | 📅 2026-09-18 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,794 | 🐛 317 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,174 | 🐛 103 | 🌐 Go | 📅 2026-09-18 - The exporter for SNMP metrics.
...
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 405 | 🐛 16 | 🌐 Go | 📅 2026-09-18 - The exporter for Graphite metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,878 | 🐛 166 | 🌐 Go | 📅 2026-09-17 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.
...
* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,091 | 🐛 14 | 🌐 Go | 📅 2026-09-18 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,751 | 🐛 821 | 🌐 Go | 📅 2026-09-21 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,210 | 🐛 908 | 🌐 Go | 📅 2026-09-21 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,864 | 🐛 342 | 🌐 Go | 📅 2026-09-21 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,899 | 🐛 213 | 🌐 Go | 📅 2026-09-21 - Scalable long-term remote storage for Prometheus.
