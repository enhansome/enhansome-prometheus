...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,055 | 🐛 889 | 🌐 Go | 📅 2026-09-11 - Prometheus' source code, issues discussion and collaboration.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 300 | 🌐 Go | 📅 2026-09-11 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,168 | 🐛 103 | 🌐 Go | 📅 2026-09-08 - The exporter for SNMP metrics.
...
* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,188 | 🐛 35 | 🌐 Astro | 📅 2026-09-12 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,684 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-12 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,090 | 🐛 9 | 🌐 Go | 📅 2026-09-13 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,707 | 🐛 798 | 🌐 Go | 📅 2026-09-12 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,203 | 🐛 905 | 🌐 Go | 📅 2026-09-11 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,862 | 🐛 348 | 🌐 Go | 📅 2026-09-12 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
