...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 66,085 | 🐛 886 | 🌐 Go | 📅 2026-09-16 - Prometheus' source code, issues discussion and collaboration.
* [Official Prometheus demo](https://demo.do.prometheus.io) - Official Prometheus demo site managed by Cloud Alchemy Ansible roles updating daily using configuration from [Prometheus repository](https://github.com/prometheus/demo-site) ⭐ 129 | 🐛 15 | 🌐 HTML | 📅 2026-09-07.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,976 | 🐛 295 | 🌐 Go | 📅 2026-09-15 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
* [Click-to-deploy Prometheus](https://github.com/GoogleCloudPlatform/click-to-deploy/tree/master/k8s/prometheus) ⭐ 773 | 🐛 207 | 🌐 Python | 📅 2026-09-16 - Source for Google Click to Deploy Prometheus solutions listed on Google Cloud Marketplace *by GoogleCloudPlatform*.
...
* [Ansitheus](https://github.com/ntk148v/ansitheus) ⭐ 30 | 🐛 2 | 🌐 Jinja | 📅 2026-09-09 - Ansible playbook to containerize, configure and deploy Prometheus ecosystem *by ntk148v*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 162 | 🌐 Go | 📅 2026-09-15 - The MySQL server exporter periodically scrapes MySQL stats.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,783 | 🐛 314 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,328 | 🐛 12 | 🌐 Java | 📅 2026-09-13 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,169 | 🐛 104 | 🌐 Go | 📅 2026-09-08 - The exporter for SNMP metrics.
* [StatsD exporter](https://github.com/prometheus/statsd_exporter) ⭐ 987 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - The exporter for StatsD metrics.
* [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) ⭐ 977 | 🐛 70 | 🌐 Java | 📅 2026-09-10 - The exporter for Amazon AWS CloudWatch metrics.
* [Graphite exporter](https://github.com/prometheus/graphite_exporter) ⭐ 405 | 🐛 18 | 🌐 Go | 📅 2026-09-01 - The exporter for Graphite metrics.
* [InfluxDB](https://github.com/prometheus/influxdb_exporter) ⭐ 291 | 🐛 10 | 🌐 Go | 📅 2026-09-01 - The exporter for InfluxDB metrics.
* [Collectd exporter](https://github.com/prometheus/collectd_exporter) ⭐ 269 | 🐛 25 | 🌐 Go | 📅 2026-09-12 - The exporter for Collectd metrics.

### Miscellaneous

* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,873 | 🐛 174 | 🌐 Go | 📅 2026-09-09 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,194 | 🐛 35 | 🌐 Astro | 📅 2026-09-12 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,682 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-15 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,090 | 🐛 4 | 🌐 Go | 📅 2026-09-14 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
* [Promxy](https://github.com/jacksontj/promxy) ⭐ 1,321 | 🐛 16 | 🌐 Go | 📅 2026-09-11 - Deduplicates data from Prometheus HA pairs.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,725 | 🐛 805 | 🌐 Go | 📅 2026-09-16 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,205 | 🐛 908 | 🌐 Go | 📅 2026-09-15 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,862 | 🐛 344 | 🌐 Go | 📅 2026-09-16 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
* [M3DB](https://github.com/m3db/m3) ⭐ 4,896 | 🐛 228 | 🌐 Go | 📅 2026-09-16 - Scalable long-term remote storage for Prometheus.
