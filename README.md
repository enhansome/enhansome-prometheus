...
* [GitHub repository](https://github.com/prometheus/prometheus) ⭐ 65,984 | 🐛 902 | 🌐 Go | 📅 2026-09-07 - Prometheus' source code, issues discussion and collaboration.
* [Official Prometheus demo](https://demo.do.prometheus.io) - Official Prometheus demo site managed by Cloud Alchemy Ansible roles updating daily using configuration from [Prometheus repository](https://github.com/prometheus/demo-site) ⭐ 129 | 🐛 15 | 🌐 HTML | 📅 2026-09-05.
...
* [Prometheus Operator](https://github.com/coreos/prometheus-operator) ⭐ 9,977 | 🐛 298 | 🌐 Go | 📅 2026-09-04 - Prometheus Operator creates/configures/manages Prometheus clusters atop Kubernetes *by CoreOS*.
...
* [MySQL server exporter](https://github.com/prometheus/mysqld_exporter) ⭐ 2,461 | 🐛 166 | 🌐 Go | 📅 2026-09-06 - The MySQL server exporter periodically scrapes MySQL stats.
...
* [Node/system metrics exporter](https://github.com/prometheus/node_exporter) ⭐ 13,766 | 🐛 309 | 🌐 Go | 📅 2026-09-03 - The Node exporter periodically scrapes system stats.
...
* [JMX exporter](https://github.com/prometheus/jmx_exporter) ⭐ 3,325 | 🐛 12 | 🌐 Java | 📅 2026-09-06 - The exporter for JMX metrics.
* [SNMP exporter](https://github.com/prometheus/snmp_exporter) ⭐ 2,167 | 🐛 103 | 🌐 Go | 📅 2026-09-06 - The exporter for SNMP metrics.
* [StatsD exporter](https://github.com/prometheus/statsd_exporter) ⭐ 987 | 🐛 25 | 🌐 Go | 📅 2026-09-02 - The exporter for StatsD metrics.
* [AWS CloudWatch exporter](https://github.com/prometheus/cloudwatch_exporter) ⭐ 977 | 🐛 67 | 🌐 Java | 📅 2026-09-03 - The exporter for Amazon AWS CloudWatch metrics.
...
* [Blackbox](https://github.com/prometheus/blackbox_exporter) ⭐ 5,863 | 🐛 175 | 🌐 Go | 📅 2026-09-01 - The Blackbox exporter allows blackbox probing of endpoints over HTTP, HTTPS, DNS, TCP and ICMP.

## Alertmanager

* [Awesome Prometheus Alerting Rules](https://github.com/samber/awesome-prometheus-alerts) ⭐ 8,182 | 🐛 50 | 🌐 Astro | 📅 2026-09-03 - Awesome List of Prometheus alerting rules.
* [Karma](https://github.com/prymitive/karma) ⭐ 2,682 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-01 - Alert dashboard for Prometheus Alertmanager.
* [Monitoring mixins](https://monitoring.mixins.dev) - Community managed bundles of alerts, recording rules, and Grafana dashboards.

## Proxies

* [Trickster](https://github.com/tricksterproxy/trickster) ⭐ 2,089 | 🐛 11 | 🌐 Go | 📅 2026-09-03 - HTTP reverse proxy/cache for HTTP applications and a dashboard query accelerator for time series databases.
...
* [VictoriaMetrics](https://github.com/VictoriaMetrics/VictoriaMetrics) ⭐ 17,665 | 🐛 784 | 🌐 Go | 📅 2026-09-07 - Cost-effective easy to operate remote storage for Prometheus.
* [Thanos](https://github.com/thanos-io/thanos) ⭐ 14,197 | 🐛 894 | 🌐 Go | 📅 2026-09-03 - Highly available Prometheus setup with long term storage capabilities.
* [Cortex](https://github.com/cortexproject/cortex) ⭐ 5,860 | 🐛 348 | 🌐 Go | 📅 2026-09-07 - Horizontally scalable, highly available, multi-tenant, long-term Prometheus.
